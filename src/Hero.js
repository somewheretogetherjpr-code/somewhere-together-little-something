...
export default function Hero({ onStart }) {
  return <motion.main className="hero" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.55 }}>
    <div className="brand"><img src="https://raw.githubusercontent.com/somewheretogetherjpr-code/somewhere-together-little-something/main/logo-lockup.png" alt="Somewhere Together" /></div>
